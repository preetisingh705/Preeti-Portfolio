...
function Tabbutton() {
  ...
  <Tabs.Root className="TabsRoot" defaultValue="tab1">
    ...
    {/* List */}
    <Tabs.List className="TabsList inline-flex items-center justify-center rounded-[30px] bg-muted p-1
    text-muted-foreground dark:md:bg-secondary w-full xl:max-w-full xl:border dark:border-[#6751b9] dark:bg-none" 
    aria-label="Personal" >

      <Tabs.Trigger 
      className="TabsTrigger inline-flex items-center justify-center whitespace-nowrap rounded-full px-3 text-white
      py-1.5 text-lg font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2
      ...
      py-1.5 text-base font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2
      focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50
